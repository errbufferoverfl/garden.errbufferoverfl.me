...
var PasteImageRenamePlugin = class extends import_obsidian2.Plugin {
  ...
  onload() {
    return __async(this, null, function* () {
      ...
      this.addCommand({
        id: "batch-rename-all-imgs",
        name: "Batch rename all imgs instantly (in the current file)",
        callback: batchRenameAllImages
      });
      if (DEBUG) {
        this.addRibbonIcon("wand-glyph", "Batch rename all imgs instantly (in the current file)", batchRenameAllImages);
      }
  ...
  batchRenameAllImages() {
    return __async(this, null, function* () {
      ...
      for (const embed of fileCache.embeds) {
        ...
        debugLog("generated newName:", newName, isMeaningful);
        if (!isMeaningful) {
          new import_obsidian2.Notice("Failed to batch rename imgs: the generated name is not meaningful");
          break;
        }
